...
def basket_price_norm_analytic(
    ...
    price = disc_fac*normal_formula(strike, forward_basket, vol_basket, texp, intr=0.0, divr=0.0, cp_sign=cp_sign)
    return price
...
#     price = 1/disc_fac * bsm_price(forward[1]+strike, forward[0], vol_r, texp, cp_sign=cp_sign)
    return price
